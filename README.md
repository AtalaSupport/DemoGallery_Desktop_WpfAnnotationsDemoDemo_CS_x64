...
This is the C# version of this app. We also have a [C# version](https://github.com/AtalaSupport/DemoGallery_Desktop_WpfAnnotationsDemoDemo_VB_x64) available.  
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_WpfAnnotationsDemoDemo_CS_x64.git WpfAnnotationsDemoDemo
```
